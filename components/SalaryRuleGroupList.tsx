...
const MOCK_GROUPS = [
  { id: 1, code: 'NQT_LUONG', name: 'Lương', description: 'Quy tắc tính lương cơ bản và lương doanh thu', itemCount: 2, items: [{id: '1_1', name: 'Lương cơ bản', code: 'LCB', description: 'Lương theo hợp đồng', bhxhHuuTri: true, bhxhOmDau: true, bhxhTnld: true, bhxhBhyt: true, bhxhBhtn: true, tncnLuyTien: true, tncnCoDinh: false, hasKhauTru: false, khauTruLimit: ''},
  ...
  { id: 2, code: 'NQT_HIEUQUA', name: 'Hiệu quả', description: 'Đánh giá KPI và hiệu suất công việc', itemCount: 2, items: [{id: '2_1', name: 'Thưởng KPI', code: 'KPI', description: 'Thưởng đạt mục tiêu', bhxhHuuTri: false, bhxhOmDau: false, bhxhTnld: false, bhxhBhyt: false, bhxhBhtn: false, tncnLuyTien: true, tncnCoDinh: false, hasKhauTru: false, khauTruLimit: ''},
  ...
  { id: 3, code: 'NQT_PHUCAP', name: 'Phụ cấp', description: 'Phụ cấp ăn trưa, đi lại, điện thoại', itemCount: 3, items: [{id: '3_1', name: 'Phụ cấp ăn trưa', code: 'PC_AN', description: 'Hỗ trợ bữa ăn giữa ca', bhxhHuuTri: false, bhxhOmDau: false, bhxhTnld: false, bhxhBhyt: false, bhxhBhtn: false, tncnLuyTien: false, tncnCoDinh: false, hasKhauTru: false, khauTruLimit: ''},
  ...
  { id: 4, code: 'NQT_BOSUNG', name: 'Bổ sung', description: 'Các khoản thu nhập bổ sung khác', itemCount: 1, items: [{id: '4_1', name: 'Tiền trách nhiệm', code: 'TTN', description: 'Thưởng trách nhiệm công việc', bhxhHuuTri: false, bhxhOmDau: false, bhxhTnld: false, bhxhBhyt: false, bhxhBhtn: false, tncnLuyTien: true, tncnCoDinh: false, hasKhauTru: false, khauTruLimit: ''}] },
  { id: 5, code: 'NQT_HOTRO', name: 'Hỗ trợ', description: 'Hỗ trợ chi phí đào tạo, trang thiết bị', itemCount: 2, items: [{id: '5_1', name: 'Hỗ trợ điện thoại', code: 'HT_DT', description: 'Cước phí viễn thông', bhxhHuuTri: false, bhxhOmDau: false, bhxhTnld: false, bhxhBhyt: false, bhxhBhtn: false, tncnLuyTien: false, tncnCoDinh: false, hasKhauTru: false, khauTruLimit: ''},
  ...
  { id: 6, code: 'NQT_BHXH', name: 'Bảo hiểm xã hội', description: 'Các khoản trích nộp bảo hiểm theo quy định', itemCount: 3, items: [{id: '6_1', name: 'BHXH (8%)', code: 'BHXH_8', description: 'Bảo hiểm xã hội người lao động đóng', bhxhHuuTri: false, bhxhOmDau: false, bhxhTnld: false, bhxhBhyt: false, bhxhBhtn: false, tncnLuyTien: false, tncnCoDinh: false, hasKhauTru: true, khauTruLimit: ''},
  ...
  { id: 7, code: 'NQT_GIAMTRU', name: 'Giảm trừ', description: 'Các khoản giảm trừ gia cảnh, phạt vi phạm', itemCount: 2, items: [{id: '7_1', name: 'Giảm trừ bản thân', code: 'GT_BT', description: 'Mức giảm trừ gia cảnh cho bản thân', bhxhHuuTri: false, bhxhOmDau: false, bhxhTnld: false, bhxhBhyt: false, bhxhBhtn: false, tncnLuyTien: false, tncnCoDinh: false, hasKhauTru: true, khauTruLimit: '11,000,000'},
  ...
  { id: 8, code: 'NQT_THUETNCN', name: 'Thuế TNCN', description: 'Thuế thu nhập cá nhân theo biểu thuế lũy tiến', itemCount: 1, items: [{id: '8_1', name: 'Thuế TNCN lũy tiến', code: 'TNCN_LT', description: 'Thuế tính theo biểu lũy tiến từng phần', bhxhHuuTri: false, bhxhOmDau: false, bhxhTnld: false, bhxhBhyt: false, bhxhBhtn: false, tncnLuyTien: false, tncnCoDinh: false, hasKhauTru: true, khauTruLimit: ''}] },
];
