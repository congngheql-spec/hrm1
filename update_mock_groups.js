...
const MOCK_GROUPS = [
  { id: 1, code: 'NQT_LUONG', name: 'Lương', description: 'Quy tắc tính lương cơ bản và lương doanh thu', itemCount: 2, items: ${JSON.stringify(itemsData[1])} },
  { id: 2, code: 'NQT_HIEUQUA', name: 'Hiệu quả', description: 'Đánh giá KPI và hiệu suất công việc', itemCount: 2, items: ${JSON.stringify(itemsData[2])} },
  { id: 3, code: 'NQT_PHUCAP', name: 'Phụ cấp', description: 'Phụ cấp ăn trưa, đi lại, điện thoại', itemCount: 3, items: ${JSON.stringify(itemsData[3])} },
  { id: 4, code: 'NQT_BOSUNG', name: 'Bổ sung', description: 'Các khoản thu nhập bổ sung khác', itemCount: 1, items: ${JSON.stringify(itemsData[4])} },
  { id: 5, code: 'NQT_HOTRO', name: 'Hỗ trợ', description: 'Hỗ trợ chi phí đào tạo, trang thiết bị', itemCount: 2, items: ${JSON.stringify(itemsData[5])} },
  { id: 6, code: 'NQT_BHXH', name: 'Bảo hiểm xã hội', description: 'Các khoản trích nộp bảo hiểm theo quy định', itemCount: 3, items: ${JSON.stringify(itemsData[6])} },
  { id: 7, code: 'NQT_GIAMTRU', name: 'Giảm trừ', description: 'Các khoản giảm trừ gia cảnh, phạt vi phạm', itemCount: 2, items: ${JSON.stringify(itemsData[7])} },
  { id: 8, code: 'NQT_THUETNCN', name: 'Thuế TNCN', description: 'Thuế thu nhập cá nhân theo biểu thuế lũy tiến', itemCount: 1, items: ${JSON.stringify(itemsData[8])} },
];
...
`
fs.writeFileSync('components/SalaryRuleGroupList.tsx', content);
